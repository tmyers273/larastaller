...
echo -n "Adding zip..."
sudo apt-get install -y php8.0-zip > /dev/null
echo "done"

echo -n "Adding php-mbstring..."
sudo apt-get install -y php8.0-mbstring > /dev/null
echo "done"
echo -n "Adding php-xml..."
sudo apt-get install -y php8.0-xml > /dev/null
echo "done";
echo -n "Adding php-curl..."
apt-get install -y php8.0-curl > /dev/null
echo "done";
